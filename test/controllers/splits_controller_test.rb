...
class SplitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create split" do
    assert_difference('Split.count') do
      post splits_url, params: { split: { account: @split.account, id_: @split.id_, memo: @split.memo, quantity: @split.quantity, reconciled_state: @split.reconciled_state, value: @split.value } }
    end
  ...
  test "should update split" do
    patch split_url(@split), params: { split: { account: @split.account, id_: @split.id_, memo: @split.memo, quantity: @split.quantity, reconciled_state: @split.reconciled_state, value: @split.value } }
