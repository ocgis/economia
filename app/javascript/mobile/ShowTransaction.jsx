...
class ShowTransaction extends ShowTransactionBase {
  ...
  render() {
    ...
    const {
      datePickerVisible, descriptionOptions, error, transaction,
    } = this.state;
    ...
    return (
      <div>
          ...
          <Grid.Item span={5} onClick={() => this.setState({ datePickerVisible: true })}>
            ...
            <CalendarPicker
              ...
              onChange={(date) => {
                ...
                this.setState({ transaction: newTransaction, datePickerVisible: false });
                this.debounceSubmit();
              }}
        ...
        { this.renderSplits() }
        <AddCircleOutline onClick={this.addSplitHandler} />
        <hr />
